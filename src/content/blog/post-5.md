...
Recomendo experimentar já pela versão **beta** mais recente. As duas últimas releases resolveram justamente pontos que sentia falta no dia a dia: telemetria de sessão passou a ser gravada por um comando determinístico do próprio binário, o `forge-sdd doctor` passou a ler esse histórico para dar um diagnóstico de verdade, e os agentes ganharam um arquivo de "lições aprendidas" atualizado a cada correção aprovada, então o mesmo erro não precisa ser redescoberto duas vezes. Na sequência veio o suporte a regras e comandos compartilhados entre diferentes agentes de IA (Claude, Gemini, Copilot), sem duplicar conteúdo entre ferramentas, além de uma estratégia mais clara de branch por feature. Dá para ver os detalhes de cada uma nas notas de lançamento: [v2.0.0-beta](https://github.com/nathanramorim/forge-sdd/releases/tag/v2.0.0-beta) e [v2.2.0-beta](https://github.com/nathanramorim/forge-sdd/releases/tag/v2.2.0-beta).
